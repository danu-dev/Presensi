...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900 font-['Inter']">Edit Galeri</h1>
        </div>
            ...
            <form action="{{ route('admin.gallery.update', $gallery->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    @if ($gallery->image_path)
                        <div class="mt-2">
                            <img src="{{ Storage::url($gallery->image_path) }}" alt="{{ $gallery->title ?? 'Galeri' }}" class="w-24 h-24 object-cover rounded-md">
