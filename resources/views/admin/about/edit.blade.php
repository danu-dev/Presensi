...
<div class="py-6">
    <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="mb-6">
            <h1 class="text-2xl font-semibold text-gray-900 font-['Inter']">Edit Konten About</h1>
        </div>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form action="{{ route('admin.about.update', $about->id) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                ...
                <div>
                    ...
                    @if ($about->image_path)
                        <div class="mt-2">
                            <img src="{{ Storage::url($about->image_path) }}" alt="{{ $about->title }}" class="w-24 h-24 object-cover rounded-md">
